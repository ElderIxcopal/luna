...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM idiomas WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $queryUpdate = "UPDATE idiomas SET 
    nombreIdioma = ?,
    desde = ?,
    hasta = ?,
    comentarios = ?,
        ...
        <div class="container">
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <label for="nombreIdioma" class="col-sm-3 col-form-label">Nombre del Idioma:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="nombreIdioma" name="nombreIdioma" value="<?= isset($nombreIdioma) ? $nombreIdioma : ''; ?>" required>
                    </div>
                </div>

...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM municipios WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $queryUpdate = "UPDATE municipios SET 
        codigoMunicipio = ?,
        nombreMunicipio = ?,
        desde = ?,
        hasta = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("ssssssssssssssssssssssi", $codigoMunicipio, $nombreMunicipio, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group row">
                        <label for="codigoMunicipio" class="col-sm-3 col-form-label">Código de Municipio:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="codigoMunicipio" name="codigoMunicipio" value="<?= isset($codigoMunicipio) ? $codigoMunicipio : ''; ?>" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="nombreMunicipio" class="col-sm-3 col-form-label">Nombre de Municipio:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="nombreMunicipio" name="nombreMunicipio" value="<?= isset($nombreMunicipio) ? $nombreMunicipio : ''; ?>" required>
                        </div>
                    </div>

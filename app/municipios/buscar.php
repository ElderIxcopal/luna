...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "codigoMunicipio" => "buscarCodigoMunicipio",
        "nombreMunicipio" => "buscarNombreMunicipio",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM municipios WHERE ";
    $condiciones = array();
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="tab-pane fade show active" id="hoja1">
                <div class="form-group row">
                    <label for="buscarCodigoMunicipio" class="col-sm-3 col-form-label">Codigo de Municipio:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarCodigoMunicipio" name="buscarCodigoMunicipio" placeholder="Ingrese el Codigo de Municipio">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarNombreMunicipio" class="col-sm-3 col-form-label">Nombre de Municipio:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarNombreMunicipio" name="buscarNombreMunicipio" placeholder="Ingrese el nombre del Municipio">
                    </div>
                </div>

...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <label for="codigoMunicipio" class="col-sm-3 col-form-label">Código del Municipio:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="codigoMunicipio" name="codigoMunicipio" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

            <div class="form-group row">
                <label for="nombreMunicipio" class="col-sm-3 col-form-label">Nombre del Municipio:</label>
                <div class="col-sm-9">
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO municipios (
                codigoMunicipio, nombreMunicipio, desde, hasta, comentarios,

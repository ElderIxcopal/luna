...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <label for="codigoNomina" class="col-sm-3 col-form-label">Código de Nómina:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="codigoNomina" name="codigoNomina" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

                <div class="form-group row">
                <label for="nombreNomina" class="col-sm-3 col-form-label">Nombre de Nómina:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombreNomina" name="nombreNomina" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
                ...
                <div class="form-group row">
                <label for="totalDescuentos" class="col-sm-3 col-form-label">Total de Descuentos:</label>
                <div class="col-sm-9">
                    <input type="number" class="form-control" id="totalDescuentos" name="totalDescuentos" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
		</div>	
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $nombreNomina = $_POST['nombreNomina'];
            $desde = $_POST['desde'];
            $hasta = $_POST['hasta'];
            ...
            $queryInsert = "INSERT INTO nominas (
                codigoNomina, nombreNomina, desde, hasta, comentarios, totalDescuentos,

...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM estados WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $queryUpdate = "UPDATE estados SET 
    estado2 = ?,
    desde = ?,
    hasta = ?,
    comentarios = ?,
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group row">
                        <label for="estado2" class="col-sm-3 col-form-label">Estado 2:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="estado2" name="estado2" value="<?= isset($estado2) ? $estado2 : ''; ?>" required>
                        </div>
                    </div>

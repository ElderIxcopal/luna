...
if (isset($_POST["buscar"])) {
    ...
    $queryBuscar = "SELECT * FROM estados WHERE ";
    $condiciones = array();
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                    <label for="buscarEstado2" class="col-sm-3 col-form-label">Estado 2:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarEstado2" name="buscarEstado2" placeholder="Ingrese el Estado 2">
                    </div>
                </div>

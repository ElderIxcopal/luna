...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM descansos WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $queryUpdate = "UPDATE descansos SET 
        empleados_id = ?,
        periodo = ?,
        desde = ?,
        hasta = ?,
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="periodo" name="periodo" value="<?= isset($periodo) ? $periodo : ''; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="tipo" name="tipo" value="<?= isset($tipo) ? $tipo : ''; ?>" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="cantidadDias" class="col-sm-3 col-form-label">Cantidad de Días:</label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="cantidadDias" name="cantidadDias" value="<?= isset($cantidadDias) ? $cantidadDias : ''; ?>" required>
                        </div>
                    </div>

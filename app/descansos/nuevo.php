...
<body>
		...
		<div class="tab-content">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="tipo" name="tipo" required>
                        ...
                        <option value="GENERADAS">GENERADAS</option>
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="cantidadDias" name="cantidadDias" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO descansos (
                empleados_id, periodo, desde, hasta, tipo, cantidadDias, comentarios,

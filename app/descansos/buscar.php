...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        ...
        "periodo" => "buscarPeriodo",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
        "tipo" => "buscarTipo",
        "cantidadDias" => "buscarCantidadDias",
    ...
    $queryBuscar = "SELECT * FROM descansos WHERE ";
    $condiciones = array();
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="buscarPeriodo" class="col-sm-3 col-form-label">Periodo:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarPeriodo" name="buscarPeriodo" placeholder="Ingrese el Periodo">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="buscarTipo" class="col-sm-3 col-form-label">Tipo:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarTipo" name="buscarTipo" placeholder="Ingrese el Tipo">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarCantidadDias" class="col-sm-3 col-form-label">Cantidad de Días:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarCantidadDias" name="buscarCantidadDias" placeholder="Ingrese la Cantidad de Días">
                    </div>
                </div>

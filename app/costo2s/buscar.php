...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "costo2" => "buscarcosto2",
        "nombreCosto2" => "buscarnombreCosto2",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM costo2s WHERE ";
    $condiciones = array();
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="tab-pane fade show active" id="hoja1">
                <div class="form-group row">
                    <label for="buscarcosto2" class="col-sm-3 col-form-label">Costo 2:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarcosto2" name="buscarcosto2" placeholder="Ingrese el costo 2">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarnombreCosto2" class="col-sm-3 col-form-label">Nombre Costo 2:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarnombreCosto2" name="buscarnombreCosto2" placeholder="Ingrese el nombre del costo 2">
                    </div>
                </div>

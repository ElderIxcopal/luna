...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <div class="form-group row">
                <label for="nombreCosto2" class="col-sm-3 col-form-label">Nombre del Costo 2:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombreCosto2" name="nombreCosto2" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO costo2s (
                costo2, nombreCosto2, desde, hasta, text1, text2, text3, comentarios,

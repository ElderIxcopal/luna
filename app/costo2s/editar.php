...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM costo2s WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $costo2 = $_POST['costo2'];
    $nombreCosto2 = $_POST['nombreCosto2'];
    $desde = $_POST['desde'];
    $hasta = $_POST['hasta'];
    ...
    $queryUpdate = "UPDATE costo2s SET 
        costo2 = ?,
        nombreCosto2 = ?,
        desde = ?,
        hasta = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("ssssssssssssssssssssssi", $costo2, $nombreCosto2, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="hoja1Editar">
                        <div class="form-group row">
                            <label for="costo2" class="col-sm-3 col-form-label">Costo 2:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="costo2" name="costo2" value="<?= isset($costo2) ? $costo2 : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="nombreCosto2" class="col-sm-3 col-form-label">Nombre Costo 2:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="nombreCosto2" name="nombreCosto2" value="<?= isset($nombreCosto2) ? $nombreCosto2 : ''; ?>" required>
                            </div>
                        </div>

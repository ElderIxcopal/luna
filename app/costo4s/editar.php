...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM costo4s WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $costo4 = $_POST['costo4'];
    $nombreCosto4 = $_POST['nombreCosto4'];
    $desde = $_POST['desde'];
    $hasta = $_POST['hasta'];
    ...
    $queryUpdate = "UPDATE costo4s SET 
        costo4 = ?,
        nombreCosto4 = ?,
        desde = ?,
        hasta = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("ssssssssssssssssssssssi", $costo4, $nombreCosto4, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="hoja1Editar">
                        <div class="form-group row">
                            <label for="costo4" class="col-sm-3 col-form-label">Costo 4:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="costo4" name="costo4" value="<?= isset($costo4) ? $costo4 : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="nombreCosto4" class="col-sm-3 col-form-label">Nombre Costo 4:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="nombreCosto4" name="nombreCosto4" value="<?= isset($nombreCosto4) ? $nombreCosto4 : ''; ?>" required>
                            </div>
                        </div>

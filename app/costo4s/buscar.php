...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "costo4" => "buscarcosto4",
        "nombreCosto4" => "buscarnombreCosto4",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM costo4s WHERE ";
    $condiciones = array();
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="tab-pane fade show active" id="hoja1">
                <div class="form-group row">
                    <label for="buscarcosto4" class="col-sm-3 col-form-label">Costo 4:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarcosto4" name="buscarcosto4" placeholder="Ingrese el Costo 4">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarnombreCosto4" class="col-sm-3 col-form-label">Nombre Costo 4:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarnombreCosto4" name="buscarnombreCosto4" placeholder="Ingrese el nombre del Costo 4">
                    </div>
                </div>

...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="costo4" name="costo4" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

            <div class="form-group row">
            <label for="nombreCosto4" class="col-sm-3 col-form-label">Nombre del Costo 4:</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="nombreCosto4" name="nombreCosto4" required>
                <div class="invalid-feedback">Este campo es obligatorio.</div>
            </div>
        </div>
				...
				<div class="form-group row">
				<label for="desde" class="col-sm-3 col-form-label">Fecha Desde:</label>
				<div class="col-sm-9">
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO costo4s (
                costo4, nombreCosto4, desde, hasta, text1, text2, text3, comentarios,

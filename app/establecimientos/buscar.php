...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "codigoEstablecimiento" => "buscarCodigoEstablecimiento",
        "nombreEstablecimiento" => "buscarNombreEstablecimiento",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM establecimientos WHERE ";
    $condiciones = array();
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                    <label for="buscarCodigoEstablecimiento" class="col-sm-3 col-form-label">Código de Establecimiento:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarCodigoEstablecimiento" name="buscarCodigoEstablecimiento" placeholder="Ingrese el Código de Establecimiento">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarNombreEstablecimiento" class="col-sm-3 col-form-label">Nombre de Establecimiento:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarNombreEstablecimiento" name="buscarNombreEstablecimiento" placeholder="Ingrese el Nombre de Establecimiento">
                    </div>
                </div>

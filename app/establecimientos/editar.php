...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM establecimientos WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $queryUpdate = "UPDATE establecimientos SET 
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group row">
                        <label for="codigoEstablecimiento" class="col-sm-3 col-form-label">Código de Establecimiento:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="codigoEstablecimiento" name="codigoEstablecimiento" value="<?= isset($codigoEstablecimiento) ? $codigoEstablecimiento : ''; ?>" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="nombreEstablecimiento" class="col-sm-3 col-form-label">Nombre de Establecimiento:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="nombreEstablecimiento" name="nombreEstablecimiento" value="<?= isset($nombreEstablecimiento) ? $nombreEstablecimiento : ''; ?>" required>
                        </div>
                    </div>

...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <label for="codigoPuesto" class="col-sm-3 col-form-label">Código del Puesto:</label>
                <div class="col-sm-9">
                ...
                <div class="form-group row">
                <label for="nombrePuesto1" class="col-sm-3 col-form-label">Nombre Puesto 1:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombrePuesto1" name="nombrePuesto1" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

                <div class="form-group row">
                <label for="nombrePuesto2" class="col-sm-3 col-form-label">Nombre Puesto 2:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombrePuesto2" name="nombrePuesto2" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

            <div class="form-group row">
                <label for="nombrePuesto3" class="col-sm-3 col-form-label">Nombre Puesto 3:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombrePuesto3" name="nombrePuesto3" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $nombrePuesto1 = $_POST['nombrePuesto1'];
            $nombrePuesto2 = $_POST['nombrePuesto2'];
            $nombrePuesto3 = $_POST['nombrePuesto3'];
            $desde = $_POST['desde'];
            $hasta = $_POST['hasta'];
            ...
            $queryInsert = "INSERT INTO puestos (
                codigoPuesto, nombrePuesto1, nombrePuesto2, nombrePuesto3, desde, hasta, comentarios,
                text1, text2, text3, string1, string2, string3, enum1, enum2, enum3,
                integer1, integer2, integer3, decimal1, decimal2, decimal3, created_at, updated_at
            ) VALUES (
                '$codigoPuesto', '$nombrePuesto1', '$nombrePuesto2', '$nombrePuesto3', '$desde', '$hasta', '$comentarios',
                '$text1', '$text2', '$text3', '$string1', '$string2', '$string3', '$enum1', '$enum2', '$enum3',
                '$integer1', '$integer2', '$integer3', '$decimal1', '$decimal2', '$decimal3', '$created_at', '$updated_at'

        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="tab-pane fade show active" id="hoja1">
                <div class="form-group row">
                    <label for="buscarcosto1" class="col-sm-3 col-form-label">Costo 1:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarCosto1" name="buscarCosto1" placeholder="Ingrese el costo 1">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarnombreCosto1" class="col-sm-3 col-form-label">Nombre Costo 1:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarnombreCosto1" name="buscarnombreCosto1" placeholder="Ingrese el nombre del costo 1">
                    </div>
                </div>

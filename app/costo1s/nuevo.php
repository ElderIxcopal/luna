...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <div class="form-group row">
                 <label for="nombreCosto1" class="col-sm-3 col-form-label">Nombre del Costo 1:</label>
                 <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombreCosto1" name="nombreCosto1" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO costo1s (
                costo1, nombreCosto1, desde, hasta, text1, text2, text3, comentarios,

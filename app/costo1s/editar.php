...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM costo1s WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $costo1 = $_POST['costo1'];
    $nombreCosto1 = $_POST['nombreCosto1'];
    $desde = $_POST['desde'];
    $hasta = $_POST['hasta'];
    ...
    $queryUpdate = "UPDATE costo1s SET 
        costo1 = ?,
        nombreCosto1 = ?,
        desde = ?,
        hasta = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("ssssssssssssssssssssssi", $costo1, $nombreCosto1, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="hoja1Editar">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="costo1" name="costo1" value="<?= isset($costo1) ? $costo1 : ''; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="nombreCosto1" name="nombreCosto1" value="<?= isset($nombreCosto1) ? $nombreCosto1 : ''; ?>" required>
                            </div>
                        </div>

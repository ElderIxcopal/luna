...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <label for="codigoDepartamento" class="col-sm-3 col-form-label">Código del Departamento:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="codigoDepartamento" name="codigoDepartamento" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

            <div class="form-group row">
                <label for="nombreDepartamento" class="col-sm-3 col-form-label">Nombre del Departamento:</label>
                <div class="col-sm-9">
				...
				<div class="form-group row">
				<label for="hasta" class="col-sm-3 col-form-label">Fecha Hasta:</label>
				<div class="col-sm-9">
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
			...
			$costo4 = $_POST['codigoDepartamento'];
            $nombreCosto4 = $_POST['nombreDepartamento'];
            ...
            $queryInsert = "INSERT INTO departamentos (
                codigoDepartamento, nombreDepartamento, desde, hasta, comentarios,
                ...
                '$costo4', '$nombreCosto4', '$desde', '$hasta', '$comentarios',
                '$text1', '$text2', '$text3', '$string1', '$string2', '$string3',
                '$enum1', '$enum2', '$enum3', '$integer1', '$integer2', '$integer3',
                '$decimal1', '$decimal2', '$decimal3', '$created_at', '$updated_at'
            )";

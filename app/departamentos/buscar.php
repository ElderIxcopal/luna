...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "codigoDepartamento" => "buscarCodigoDepartamento",
        "nombreDepartamento" => "buscarNombreDepartamento",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM departamentos WHERE ";
    $condiciones = array();
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                    <label for="buscarCodigoDepartamento" class="col-sm-3 col-form-label">Código Departamento:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="buscarCodigoDepartamento" name="buscarCodigoDepartamento" placeholder="Ingrese el Código Departamento">
                        </div>
                    </div>

                    <div class="form-group row">
                    <label for="buscarNombreDepartamento" class="col-sm-3 col-form-label">Nombre Departamento:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="buscarNombreDepartamento" name="buscarNombreDepartamento" placeholder="Ingrese el nombre del Departamento">
                        </div>
                    </div>
                <div class="form-group row">

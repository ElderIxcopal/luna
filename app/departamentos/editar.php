...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM departamentos WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $queryUpdate = "UPDATE departamentos SET 
        codigoDepartamento = ?,
        nombreDepartamento = ?,
        desde = ?,
        hasta = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("ssssssssssssssssssssssi", $codigoDepartamento, $nombreDepartamento, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="hoja1Editar">
                        <div class="form-group row">
                            <label for="codigoDepartamento" class="col-sm-3 col-form-label">Codigo de Departamento:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="codigoDepartamento" name="codigoDepartamento" value="<?= isset($codigoDepartamento) ? $codigoDepartamento : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="nombreDepartamento" class="col-sm-3 col-form-label">Nombre de departamento:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="nombreDepartamento" name="nombreDepartamento" value="<?= isset($nombreDepartamento) ? $nombreDepartamento : ''; ?>" required>
                            </div>
                        </div>

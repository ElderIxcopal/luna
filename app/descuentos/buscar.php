...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "empleados_id" => "buscarEmpleadosId",
        "tipo_id" => "buscarTipoId",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
        "totalDescuento" => "buscarTotalDescuento",
        "cantidadAbonos" => "buscarCantidadAbonos",
        "cuotaQuincenal" => "buscarCuotaQuincenal",
        "documentoDescuento" => "buscarDocumentoDescuento",
    ...
    $queryBuscar = "SELECT * FROM descuentos WHERE ";
    $condiciones = array();
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                    <label for="buscarEmpleadosId" class="col-sm-3 col-form-label">Empleados ID:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarEmpleadosId" name="buscarEmpleadosId" placeholder="Ingrese el Empleados ID">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarTipoId" class="col-sm-3 col-form-label">Tipo ID:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarTipoId" name="buscarTipoId" placeholder="Ingrese el Tipo ID">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="buscarTotalDescuento" class="col-sm-3 col-form-label">Total Descuento:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarTotalDescuento" name="buscarTotalDescuento" placeholder="Ingrese el Total Descuento">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarCantidadAbonos" class="col-sm-3 col-form-label">Cantidad Abonos:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarCantidadAbonos" name="buscarCantidadAbonos" placeholder="Ingrese la Cantidad de Abonos">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarCuotaQuincenal" class="col-sm-3 col-form-label">Cuota Quincenal:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarCuotaQuincenal" name="buscarCuotaQuincenal" placeholder="Ingrese la Cuota Quincenal">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarDocumentoDescuento" class="col-sm-3 col-form-label">Documento Descuento:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarDocumentoDescuento" name="buscarDocumentoDescuento" placeholder="Ingrese el Documento de Descuento">
                    </div>
                </div>

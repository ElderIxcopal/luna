...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <label for="empleados_id" class="col-sm-3 col-form-label">ID del Empleado:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="empleados_id" name="empleados_id" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

                <div class="form-group row">
                <label for="tipo_id" class="col-sm-3 col-form-label">Tipo ID:</label>
                <div class="col-sm-9">
                ...
                <div class="col-sm-9">
                    <input type="number" step="0.01" class="form-control" id="totalDescuento" name="totalDescuento" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    <input type="number" class="form-control" id="cantidadAbonos" name="cantidadAbonos" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    <input type="number" step="0.01" class="form-control" id="cuotaQuincenal" name="cuotaQuincenal" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

                <div class="form-group row">
                <label for="documentoDescuento" class="col-sm-3 col-form-label">Documento Descuento:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="documentoDescuento" name="documentoDescuento" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO descuentos (
                empleados_id, tipo_id, desde, hasta, totalDescuento, cantidadAbonos, cuotaQuincenal, documentoDescuento, comentarios,

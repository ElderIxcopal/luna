...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM descuentos WHERE id = ?";
    ...
    if ($stmt = $conn->prepare($queryBuscar)) {
        ...
        if ($resultBuscar->num_rows > 0) {
            ...
            $empleados_id = $row['empleados_id'];
            $tipo_id = $row['tipo_id'];
            $desde = $row['desde'];
            $hasta = $row['hasta'];
            $totalDescuento = $row['totalDescuento'];
            $cantidadAbonos = $row['cantidadAbonos'];
            $cuotaQuincenal = $row['cuotaQuincenal'];
            $documentoDescuento = $row['documentoDescuento'];
...
if (isset($_POST["actualizar"])) {
    ...
    $cantidadAbonos = $_POST['cantidadAbonos'];
    $cuotaQuincenal = $_POST['cuotaQuincenal'];
    $documentoDescuento = $_POST['documentoDescuento'];
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="hoja1Editar">
                        <div class="form-group row">
                            <label for="empleados_id" class="col-sm-3 col-form-label">ID de Empleados:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="empleados_id" name="empleados_id" value="<?= isset($empleados_id) ? $empleados_id : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="tipo_id" class="col-sm-3 col-form-label">ID de Tipo:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="tipo_id" name="tipo_id" value="<?= isset($tipo_id) ? $tipo_id : ''; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="totalDescuento" class="col-sm-3 col-form-label">Total de Descuento:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="totalDescuento" name="totalDescuento" value="<?= isset($totalDescuento) ? $totalDescuento : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="cantidadAbonos" class="col-sm-3 col-form-label">Cantidad de Abonos:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="cantidadAbonos" name="cantidadAbonos" value="<?= isset($cantidadAbonos) ? $cantidadAbonos : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="cuotaQuincenal" class="col-sm-3 col-form-label">Cuota Quincenal:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="cuotaQuincenal" name="cuotaQuincenal" value="<?= isset($cuotaQuincenal) ? $cuotaQuincenal : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="documentoDescuento" class="col-sm-3 col-form-label">Documento de Descuento:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="documentoDescuento" name="documentoDescuento" value="<?= isset($documentoDescuento) ? $documentoDescuento : ''; ?>" required>
                            </div>
                        </div>

...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "codigoNacionalidad" => "buscarCodigoNacionalidad",
        "pais" => "buscarPais",
        "nacionalidad" => "buscarNacionalidad",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM nacionalidades WHERE ";
    $condiciones = array();
...
<body>
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <label for="buscarCodigoNacionalidad" class="col-sm-3 col-form-label">Código de Nacionalidad:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="buscarCodigoNacionalidad" name="buscarCodigoNacionalidad" placeholder="Ingrese el Código de Nacionalidad">
                </div>
            </div>

        <div class="form-group row">
            <label for="buscarPais" class="col-sm-3 col-form-label">País:</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="buscarPais" name="buscarPais" placeholder="Ingrese el País">
            </div>
        </div>

        <div class="form-group row">
            <label for="buscarNacionalidad" class="col-sm-3 col-form-label">Nacionalidad:</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="buscarNacionalidad" name="buscarNacionalidad" placeholder="Ingrese la Nacionalidad">
            </div>
        </div>

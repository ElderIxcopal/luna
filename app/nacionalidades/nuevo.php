...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="codigoNacionalidad" name="codigoNacionalidad" required>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO nacionalidades (
                codigoNacionalidad, pais, nacionalidad, desde, hasta, comentarios,

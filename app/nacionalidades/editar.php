...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM nacionalidades WHERE id = ?";
    ...
    if ($stmt = $conn->prepare($queryBuscar)) {
        ...
        if ($resultBuscar->num_rows > 0) {
            ...
            $codigoNacionalidad = $row['codigoNacionalidad'];
            $pais = $row['pais'];
...
if (isset($_POST["actualizar"])) {
    ...
    $codigoNacionalidad = $_POST['codigoNacionalidad'];
    $pais = $_POST['pais'];
    ...
    $queryUpdate = "UPDATE nacionalidades SET 
        codigoNacionalidad = ?,
        pais = ?,
        nacionalidad = ?,
        desde = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("sssssssssssssssssssssssi", $codigoNacionalidad, $pais, $nacionalidad, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group row">
                        <label for="codigoNacionalidad" class="col-sm-3 col-form-label">Código de Nacionalidad:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="codigoNacionalidad" name="codigoNacionalidad" value="<?= isset($codigoNacionalidad) ? $codigoNacionalidad : ''; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="pais" name="pais" value="<?= isset($pais) ? $pais : ''; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="nacionalidad" name="nacionalidad" value="<?= isset($nacionalidad) ? $nacionalidad : ''; ?>" required>
                        </div>
                    </div>

...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM ocupaciones WHERE id = ?";
    ...
    if ($stmt = $conn->prepare($queryBuscar)) {
        ...
        if ($resultBuscar->num_rows > 0) {
            ...
            $nombreOcupacion = $row['nombreOcupacion'];
            $desde = $row['desde'];
            $hasta = $row['hasta'];
...
if (isset($_POST["actualizar"])) {
    ...
    $nombreOcupacion = $_POST['nombreOcupacion'];
    $desde = $_POST['desde'];
    $hasta = $_POST['hasta'];
    ...
    $queryUpdate = "UPDATE ocupaciones SET 
        codigoOcupacion = ?,
        nombreOcupacion = ?,
        desde = ?,
        hasta = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("ssssssssssssssssssssssi", $codigoOcupacion, $nombreOcupacion, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group row">
                        <label for="codigoOcupacion" class="col-sm-3 col-form-label">Código de Ocupación:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="codigoOcupacion" name="codigoOcupacion" value="<?= isset($codigoOcupacion) ? $codigoOcupacion : ''; ?>" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="nombreOcupacion" class="col-sm-3 col-form-label">Nombre de Ocupación:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="nombreOcupacion" name="nombreOcupacion" value="<?= isset($nombreOcupacion) ? $nombreOcupacion : ''; ?>" required>
                        </div>
                    </div>

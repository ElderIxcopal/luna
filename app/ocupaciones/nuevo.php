...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="codigoOcupacion" name="codigoOcupacion" required>
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombreOcupacion" name="nombreOcupacion" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO ocupaciones (
                codigoOcupacion, nombreOcupacion, desde, hasta, comentarios,
            ...
            // Ejecutar la consulta de inserción aquí...

...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "codigoOcupacion" => "buscarCodigoOcupacion",
        "nombreOcupacion" => "buscarNombreOcupacion",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM ocupaciones WHERE ";
    $condiciones = array();
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                <label for="buscarCodigoOcupacion" class="col-sm-3 col-form-label">Código de Ocupación:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="buscarCodigoOcupacion" name="buscarCodigoOcupacion" placeholder="Ingrese el Código de Ocupación">
                </div>
            </div>

            <div class="form-group row">
                <label for="buscarNombreOcupacion" class="col-sm-3 col-form-label">Nombre de Ocupación:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="buscarNombreOcupacion" name="buscarNombreOcupacion" placeholder="Ingrese el Nombre de Ocupación">
                </div>
            </div>

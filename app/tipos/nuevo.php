...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="codigoDescuento" name="codigoDescuento" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

            <div class="form-group row">
                <label for="nombreDescuento" class="col-sm-3 col-form-label">Nombre del Descuento:</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="cuentaContable" class="col-sm-3 col-form-label">Cuenta Contable:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="cuentaContable" name="cuentaContable" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

            <div class="form-group row">
                <label for="nombreCuenta" class="col-sm-3 col-form-label">Nombre de la Cuenta:</label>
                <div class="col-sm-9">
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO tipos (
                codigoDescuento, nombreDescuento, cuentaContable, nombreCuenta, comentarios,

...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM costo3s WHERE id = ?";
...
if (isset($_POST["actualizar"])) {
    ...
    $costo3 = $_POST['costo3'];
    $nombreCosto3 = $_POST['nombreCosto3'];
    $desde = $_POST['desde'];
    $hasta = $_POST['hasta'];
    ...
    $queryUpdate = "UPDATE costo3s SET 
        costo3 = ?,
        nombreCosto3 = ?,
        desde = ?,
        hasta = ?,
    ...
    if ($stmt = $conn->prepare($queryUpdate)) {
        ...
        $stmt->bind_param("ssssssssssssssssssssssi", $costo3, $nombreCosto3, $desde, $hasta, $comentarios, $text1,  $text2,	$text3,	$string1, $string2, $string3, $enum1, $enum2, $enum3, $integer1, $integer2, $integer3, $decimal1, $decimal2, $decimal3, $created_at, $updated_at, $idRegistroEditar);
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="hoja1Editar">
                        <div class="form-group row">
                            <label for="costo3" class="col-sm-3 col-form-label">Costo 3:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="costo3" name="costo3" value="<?= isset($costo3) ? $costo3 : ''; ?>" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="nombreCosto3" class="col-sm-3 col-form-label">Nombre Costo 3:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="nombreCosto3" name="nombreCosto3" value="<?= isset($nombreCosto3) ? $nombreCosto3 : ''; ?>" required>
                            </div>
                        </div>

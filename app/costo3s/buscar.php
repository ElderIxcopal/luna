...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "costo3" => "buscarcosto3",
        "nombreCosto3" => "buscarnombreCosto3",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM costo3s WHERE ";
    $condiciones = array();
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="tab-pane fade show active" id="hoja1">
                <div class="form-group row">
                    <label for="buscarcosto3" class="col-sm-3 col-form-label">Costo 3:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarcosto3" name="buscarcosto3" placeholder="Ingrese el Costo 3">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="buscarnombreCosto3" class="col-sm-3 col-form-label">Nombre Costo 3:</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="buscarnombreCosto3" name="buscarnombreCosto3" placeholder="Ingrese el nombre del Costo 3">
                    </div>
                </div>

...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="costo3" name="costo3" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>

                 <div class="form-group row">
                <label for="nombreCosto3" class="col-sm-3 col-form-label">Nombre del Costo 3:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombreCosto3" name="nombreCosto3" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO costo3s (
                costo3, nombreCosto3, desde, hasta, text1, text2, text3, comentarios,

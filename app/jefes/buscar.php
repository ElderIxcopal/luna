...
if (isset($_POST["buscar"])) {
    ...
    $queryBuscar = "SELECT * FROM jefes WHERE ";
    $condiciones = array();
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                <label for="buscarNombreJefe" class="col-sm-3 col-form-label">Nombre del Jefe:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="buscarNombreJefe" name="buscarNombreJefe" placeholder="Ingrese el Nombre del Jefe">
                </div>
            </div>

...
if ($idRegistroEditar !== null) {
    ...
    $queryBuscar = "SELECT * FROM jefes WHERE id = ?";
        ...
        <div class="container">
            ...
            <form name="feditar" method="post" action="<?=$_SERVER['PHP_SELF']?>" class="needs-validation" novalidate>
                ...
                <div class="tab-content">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="nombreJefe" name="nombreJefe" value="<?= isset($nombreJefe) ? $nombreJefe : ''; ?>" required>
                    </div>
                </div>

...
<body>
    ...
    <div class="container">
        ...
        <form name="fcrearemp" method="post" action="<?=$_SERVER['PHP_SELF']?>" onSubmit="return validar_campos();" class="needs-validation" novalidate>
			...
			<div class="tab-content">
				...
				<label for="nombreJefe" class="col-sm-3 col-form-label">Nombre del Jefe:</label>
				<div class="col-sm-9">
					<input type="text" class="form-control" id="nombreJefe" name="nombreJefe" required>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO jefes (
                nombreJefe, desde, hasta, text1, text2, text3, comentarios,

...
if (isset($_POST["buscar"])) {
    ...
    $camposBusqueda = array(
        "codigoEstudio" => "buscarCodigoEstudio",
        "nombreEstudio" => "buscarNombreEstudio",
        "desde" => "buscarDesde",
        "hasta" => "buscarHasta",
    ...
    $queryBuscar = "SELECT * FROM estudios WHERE ";
    $condiciones = array();
...
<body>
    ...
    <div class="container">
        ...
        <form name="fbuscar" method="post" action="buscar.php" class="needs-validation" novalidate>
            ...
            <label for="buscarCodigoEstudio" class="col-sm-3 col-form-label">Código de Estudio:</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="buscarCodigoEstudio" name="buscarCodigoEstudio" placeholder="Ingrese el Código de Estudio">
            </div>
        </div>

        <div class="form-group row">
            <label for="buscarNombreEstudio" class="col-sm-3 col-form-label">Nombre de Estudio:</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="buscarNombreEstudio" name="buscarNombreEstudio" placeholder="Ingrese el Nombre de Estudio">
            </div>
        </div>

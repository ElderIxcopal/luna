...
<body>
    ...
    <div class="container">
		...
		<div class="tab-content">
                ...
                <label for="codigoEstudio" class="col-sm-3 col-form-label">Código del Estudio:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="codigoEstudio" name="codigoEstudio" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nombreEstudio" name="nombreEstudio" required>
                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                </div>
            </div>
    ...
    <?php 
        if(isset($_POST["gordeemp"])) {
            ...
            $queryInsert = "INSERT INTO estudios (
                codigoEstudio, nombreEstudio, desde, hasta, comentarios,
